...
export function CartSidebar({
  ...
  return (
    <div className="hidden xl:flex w-[340px] flex-col shrink-0 p-3 pl-0">
      <div className="flex flex-col flex-1 bg-white rounded-2xl overflow-hidden border border-black/[0.04]">
